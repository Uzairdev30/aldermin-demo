...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Academic Year</h4>
    </div>
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form method="POST" action="{{ route('sass.setting.academic-year.store')}}" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    <label for="academic_year_name">Academic Year Name</label>  <span class="text-danger">*</span>
                                    <input type="text" class="form-control @error('academic_year_name') is-invalid @enderror" name="academic_year_name" value="{{ old('academic_year_name') }}">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('start_date') is-invalid @enderror" name="start_date" id="start_date" value="{{ old('start_date') }}">
                                ...
                                <button class="btn btn-primary" type="submit">Save Academic Year </button>
                            </div>
                        </form>
                    </div>
                </div>
