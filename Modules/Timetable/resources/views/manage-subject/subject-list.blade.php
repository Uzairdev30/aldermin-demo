...
<div class="row page-titles">
    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item mr-2"><a href="javascript:void(0)">Home</a></li>
            </ol>

            <div class="btn-group">
                <button type="button" class="btn btn-outline-info dropdown-toggle mr-2"
                    data-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false">Subject Center</button>
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{ route('saas.manage-subject.Course-subject.index') }}">Course Subjects</a>
                    <a class="dropdown-item" href="{{ route('saas.manage-subject.skill-set.index') }}">Skill Sets</a>
                    <a class="dropdown-item" href="{{ route('saas.manage-subject.link-batch.index') }}">Link Batches</a>
                </div>
            </div>
        </div>
    </div>
