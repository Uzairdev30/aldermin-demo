...
@section('title', 'Institutional TimeTable')
...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Institutional TimeTable</h4>
    </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Institutional TimeTable</h4>
                        ...
                        <form method="POST" action="" novalidate>
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3 text-center">
                                    ...
                                    <input type="text" class="form-control @error(''){{ 'is-invalid' }}@enderror" value="" placeholder="" name="start_date" id="start_date">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>
                            </div>
                            <button class="btn btn-primary d-block mx-auto" type="submit">Search</button> 
                        </form>
                    </div>
                </div>
            </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Institutional TimeTable List</h4>
