...
@section('title', 'Set Weekdays & Class Timing Set')
...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Set Weekdays & Class Timing Set</h4>
    </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Set Weekdays & Class Timing Set</h4>
                <div class="row">
                    <div class="col-md-12">
