...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Create Set Class Timing</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                <!-- <li class="breadcrumb-item mr-2"><a href=""></a></li> -->
                 <a href="{{ route('saas.set-class-timing.create') }}" class="btn btn-info d-none d-lg-block mr-2"><i class="fa fa-plus-circle"></i> Create Set Class Timing
            </a>
            </ol>
        </div>
    </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Set Class Timing List</h4>
