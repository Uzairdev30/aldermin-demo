...
<div class="row page-titles">
    ...
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            ...
            <a href="{{ route('saas.classroom-allocation.manage-building.create') }}" class="btn btn-info d-none d-lg-block mr-2"><i class="fa fa-plus-circle"></i> Add Building
            </a>

            <a href="{{ route('saas.classroom-allocation.allocate.index') }}" class="btn btn-info d-none d-lg-block mr-2"> Aollcate </a>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Manage Building List</h4>
