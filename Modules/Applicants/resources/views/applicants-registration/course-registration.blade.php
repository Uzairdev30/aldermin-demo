...
@section('title', 'Academic Year Wise Applicant List')
...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Applicant Registration</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('sass.applicant.course-applicant.index') }}">< course applicants</a></li>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Academic Year Wise Applicant List</h4>
                <div class="row">
                    <div class="col-md-12">
