...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Score Import</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            ...
            <a href="{{ route('saas.grade-book.back-data-import.score-import.logs') }}" class="btn btn-info d-none d-lg-block mr-2"> Import Logs </a>
...
<div class="row">
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Score Import</h4>
                <div class="row">
                    <div class="col-md-12">
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Score Import List</h4>
