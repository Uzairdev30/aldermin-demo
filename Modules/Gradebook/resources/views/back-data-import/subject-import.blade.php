...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Subject Import</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            ...
            <a href="{{ route('saas.grade-book.back-data-import.subject-import.logs') }}" class="btn btn-info d-none d-lg-block mr-2"> Import Logs </a>
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{ route('saas.grade-book.back-data-import.score-import.index') }}">Score Import</a>
                    <a class="dropdown-item" href="{{ route('saas.grade-book.back-data-import.view-import-data.index') }}">View Imported Data </a>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Subject Import</h4>
                <div class="row">
                    <div class="col-md-12">
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Subject Import List</h4>
                    ...
                    <table id="data_table" class="display nowrap table table-hover table-striped table-bordered"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>Example and Institutional</th>
