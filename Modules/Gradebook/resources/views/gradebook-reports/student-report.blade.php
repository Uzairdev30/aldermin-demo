...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Manage Academic Year</h4>
    </div>
            ...
            <ol class="breadcrumb">
             ...
             <div class="btn-group">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{ route('saas.grade-book.subject-report.academic-year.index') }}">Subject Report</a>
                    <a class="dropdown-item" href="{{ route('saas.grade-book.consolidated-report.academic-year.index') }}">Consolidated Reports</a>
                </div>
            </div>

            <a href="" class="btn btn-info d-none d-lg-block mr-2"                      data-toggle="modal"data-target="#myModel"> <i class="fa fa-plus-circle"></i>
             New Academic Year
            </a>
        </div>
    </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Manage Academic Year</h4>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="vcenter">New Academic Year</h4>
