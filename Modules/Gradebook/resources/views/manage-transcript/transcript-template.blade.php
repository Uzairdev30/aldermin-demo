...
@section('title', 'Transcript Template')
...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Transcript Template</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                <!-- <li class="breadcrumb-item active"><a href="javascript:void(0)">Setting</a></li> -->
                 <li class="breadcrumb-item mr-2"><a href="{{ route('saas.grade-book.manage-transcript.index')}}">< Manage Transcript</a></li>
            </ol>

            <a href="{{ route('saas.grade-book.manage-transcript-template.create') }}" class="btn btn-info d-none d-lg-block mr-2"><i class="fa fa-plus-circle"></i> Add Transcript Template</a>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Transcript Template List</h4>
