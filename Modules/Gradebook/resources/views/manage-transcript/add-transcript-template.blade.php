...
@section('title', 'Add Transcript Template')
...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Add Transcript Template</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                <!-- <li class="breadcrumb-item active"><a href="javascript:void(0)">Setting</a></li> -->
                <li class="breadcrumb-item"><a href="{{ route('saas.grade-book.manage-transcript-template.index')}}">< Transcript Template</a></li>
            </ol>            
        </div>
    </div>
</div>
