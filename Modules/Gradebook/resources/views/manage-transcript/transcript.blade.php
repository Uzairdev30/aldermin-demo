...
@section('title', 'Manage Transcript')
...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Manage Transcript</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            ...
            <a href="{{ route('saas.grade-book.manage-transcript-template.index') }}" class="btn btn-info d-none d-lg-block mr-2"> Transcript Templates </a>
            <a href="{{ route('saas.grade-book.generate-transcript.index') }}" class="btn btn-info d-none d-lg-block mr-2"> Generate Transcripts </a>
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{ route('saas.grade-book.bulk-download.index') }}">Bulk Download</a>
                    <a class="dropdown-item" href="">Transcript Report Logs </a>
                    <a class="dropdown-item" href="">Generated Transcript Report </a>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Manage Transcript</h4>
                <div class="row">
                    <div class="col-md-12">
